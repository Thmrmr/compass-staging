...
return(<div>
  ...
  return(<div style={{...th,fontFamily:"'ABC Repro','Inter','DM Sans',sans-serif",background:"var(--bg)",color:"var(--text)",minHeight:"100vh",display:"flex"}}>
    ...
    {tourStep>=0&&(()=>{const steps=[
      {title:"Welcome to COMPASS",tab:"Home",desc:"HUMAIN COMPASS is a sovereign AI-powered CRM and intelligence platform built for the HUMAIN sales and marketing team.",bullets:["12 AI agents that analyze your pipeline in real-time","Claude-powered chat with live deal context","Voice input in English and Arabic"]},
